...
const ConclusionAlt = () => {
  return (
    <section className="relative w-full py-28 px-4 flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-transparent via-[#18181b] to-black">
      <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto">
        <div className="uppercase tracking-widest text-red-500 font-semibold text-sm mb-4 font-poppins">Why join Hackosquad?</div>
        <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 font-poppins drop-shadow-lg">
          Ready to join the next generation of cybersecurity?
        </h2>
        <p className="text-lg md:text-2xl text-gray-300 mb-10 font-poppins max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-6 mb-10">
          {benefits.map((b, i) => (
            <div key={i} className="flex items-center gap-2 text-lg text-gray-200 font-poppins">
        ...
        {/* Soft Divider */}
        <div className="w-24 h-1 rounded-full bg-gradient-to-r from-red-600 via-red-400 to-red-600 opacity-40 mb-10 mx-auto" />
        {/* CTAs */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-4">
          <a
            href="#signup"
            className="inline-block bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-10 rounded-full shadow-lg transition-all duration-200 text-xl font-poppins"
          >
            Get Started
          </a>
          <a
