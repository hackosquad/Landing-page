...
const FAQs = () => {
  ...
  return (
    <section id="faq" className="w-full bg-black py-2 px-4">
      <div className="flex justify-center mb-12">
        <div className="w-full max-w-2xl h-1 rounded-full bg-gradient-to-r from-black via-red-600 to-black shadow-[0_0_16px_2px_rgba(255,0,0,0.25)] relative">
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-2 bg-red-600 rounded-full blur-md opacity-60 animate-pulse" />
        </div>
      </div>
      <div className="max-w-4xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-10 text-center font-poppins">
        ...
        <div className="space-y-6">
          {faqs.map((faq, i) => (
            <div
              key={i}
              className="border-b border-red-900/40 pb-4"
            >
              <button
                className="w-full text-left flex justify-between items-center text-lg md:text-xl font-semibold text-white focus:outline-none"
